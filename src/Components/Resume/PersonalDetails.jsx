        ...
        <div className="row justify-content-around  border-bottom py-4 ">
            ...
            <div className='px-md-5 px-2'>
              <form>
                ...
                <div className="input-container my-3">
                  ...
                  <input type="text" className='form-control p-2 ' placeholder='Your Portfolio ' />

                </div>
                <div className="input-container my-lg-3 mb-0">
                  <i className="fa-brands fa-linkedin fa-lg"></i>
                  <input type="text" className='form-control p-2 ' placeholder='Linkedin *' />
                </div>
          ...
          <div className="col-lg-5">
            <div className='px-md-5 px-2'>
              <form >
                <div  className='my-3'>
                  <input type="text" className='form-control p-2 ' placeholder='Enter your title eg.Frontend developer *' />
                </div>
                <div className="input-container my-3">
                  <i className="fa-solid fa-phone fa-lg"></i>
                  <input type="tel" className='form-control p-2' placeholder='Phone number *' />
                </div>
                <div className="input-container  my-3">
                  <i className="fa-brands fa-square-github fa-lg"></i>
                  <input type="text" className='form-control p-2' placeholder='GitHub ' />

                </div>
                <div className="input-container  my-3">
                  <i className="fa-brands fa-facebook fa-lg"></i>
                  <input type="text" className='form-control p-2' placeholder='Facebook *' />
                </div>
